...
export default function Apply() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data } = await api.post(`/services/${id}/apply`, payload, {
        ...
        <div className="col-md-7">
          <div className="card form-card text-center">
            <div className="card-body p-5">
              ...
              <p className="text-muted">Your application for <strong>{result.service.name}</strong> has been received.</p>
              ...
              <div className="d-flex gap-2 justify-content-center mt-3 flex-wrap">
                ...
                <Link to="/applications/mine" className="btn btn-primary">View My Applications</Link>
                <Link to="/services" className="btn btn-outline-secondary">Browse More Services</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="col-md-8">
        ...
        <div className="card form-card">
          <div className="card-body p-4">
            <h3 className="mb-1"><i className="fa-solid fa-file-pen"></i> Apply for {service.name}</h3>
            <p className="text-muted mb-4">Fee: ₹{service.fee} &middot; Processing time: ~{service.processing_days} days</p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-muted small">Required: {service.required_documents} (JPG, PNG or PDF, max 5MB each)</p>
